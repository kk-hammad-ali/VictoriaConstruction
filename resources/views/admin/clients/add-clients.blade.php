                        ...
                        <div class="card-body p-4">
                            ...
                            <form class="user" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('property') is-invalid @enderror"
                                        id="property_selected" name="property" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control @error('primary_phoneNo') is-invalid @enderror"
