...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav" id="second-nav-items">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">RENTAL APPOINTMENT</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid p-0">
        <div class="position-relative" style="height: 50vh;">
            <img src="{{ asset('img/bg.jpg') }}" class="img-fluid position-absolute"
                style="object-fit: cover; width: 100%; height: 100%; max-height: 50vh;">
            <button class="btn btn-light text-primary position-absolute"
                style="top: 50%; left: 20%; transform: translate(-50%, -50%);">HOME | OUR WORK</button>
        </div>
    </div>
