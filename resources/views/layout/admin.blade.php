...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2"
                ...
                <div class="sidebar-brand-text mx-3">Victoria Construction Admin</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#agents"
                    aria-expanded="true" aria-controls="agents">
            ...
            <li class="nav-item">
                ...
                <div id="applications" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('ourteam.applied_application') }}">Applied
                            Applications</a>
                        <a class="collapse-item" href="{route('admin.extra.all_rental_appointments')}}">Rental
                            Appointments</a>
                    </div>
                </div>
            </li>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('admin.change_password') }}">
                    ...
                    <div class="modal-body">
                        ...
                        @endif
                        @if (session('password_changed_custom'))
                            <div class="alert alert-success">
                                {{ session('password_changed_custom') }}
                            </div>
                        @endif
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn"
                            style="background-color: #4ab242;color:white; font-size:18px;">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            @if (session('error_custom') || session('password_changed_custom'))
